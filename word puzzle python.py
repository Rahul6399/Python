...
score=0;
window=Tk()
window.title("Scrambled word puzzle")
    ...
    if word in word_list:
        ...
        if flag == 1 and len(word) > 3:
            for i in range(0,len(li)):
                if li[i]==word:
                     messagebox.showinfo("ALERT","word already typed")
            score=score+len(word)
            total="score ={} ".format(str(score))
            label.configure(text=total)
            print(word)
            li.append(word)
        else:
            messagebox.showinfo("Check","No match with above word OR word length should be greater than 3")
    else:
        print("No Word")
...
def quit_pro():
    messagebox.showinfo("Oops!!","Time Up! Your Score {}".format(str(score)))
    window.destroy()
...
btn5 = Button(window, text="X",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn6 = Button(window, text="Y",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn9 = Button(window, text="S",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn9.grid(column=9, row=2)
btn10 = Button(window, text="T",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn10.grid(column=10, row=2)
btn11 = Button(window, text="B",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn11.grid(column=11, row=2)
btn12 = Button(window, text="M",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn3 = Button(window, text="T",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn9 = Button(window, text="P",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn11 = Button(window, text="D",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn1 = Button(window, text="O",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn1.grid(column=1, row=4)
btn2 = Button(window, text="U",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn2.grid(column=2, row=4)
btn3 = Button(window, text="X",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn3.grid(column=3, row=4)
btn4 = Button(window, text="O",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn4.grid(column=4, row=4)
btn5 = Button(window, text="M",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn8 = Button(window, text="E",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn10 = Button(window, text="P",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn12 = Button(window, text="I",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn6 = Button(window, text="Q",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn9 = Button(window, text="J",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn12 = Button(window, text="T",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn12.grid(column=12, row=6)

btn1 = Button(window, text="E",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn3 = Button(window, text="W",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn3.grid(column=3, row=7)
btn4 = Button(window, text="V",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn6 = Button(window, text="J",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn6.grid(column=6, row=7)
btn7 = Button(window, text="T",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn7.grid(column=7, row=7)
btn8 = Button(window, text="U",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn10 = Button(window, text="F",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn10.grid(column=10, row=7)
btn11 = Button(window, text="Q",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn11.grid(column=11, row=7)
btn12 = Button(window, text="O",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn12.grid(column=12, row=7)

btn1 = Button(window, text="Y",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn6 = Button(window, text="E",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn6.grid(column=6, row=8)
btn7 = Button(window, text="W",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn7.grid(column=7, row=8)
btn8 = Button(window, text="X",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn8.grid(column=8, row=8)
btn9 = Button(window, text="Z",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn1 = Button(window, text="H",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn9 = Button(window, text="B",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn9.grid(column=9, row=9)
btn10 = Button(window, text="U",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn1 = Button(window, text="l",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn1.grid(column=1, row=10)
btn2 = Button(window, text="A",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn2.grid(column=2, row=10)
btn3 = Button(window, text="D",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn7 = Button(window, text="H",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn9 = Button(window, text="M",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn9.grid(column=9, row=10)
btn10 = Button(window, text="Z",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn2 = Button(window, text="D",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn6 = Button(window, text="B",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn1 = Button(window, text="U",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn1.grid(column=1, row=12)
btn2 = Button(window, text="E",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn2.grid(column=2, row=12)
btn3 = Button(window, text="A",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn3.grid(column=3, row=12)
btn4 = Button(window, text="R",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
btn4.grid(column=4, row=12)
btn5 = Button(window, text="G",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn8 = Button(window, text="K",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
btn11 = Button(window, text="W",bg="White", fg="Black",width=3,height=1,font=('Helvetica','20'))
...
word_check=Entry(window,width=50, bd=10)
word_check.configure(highlightbackground="red", highlightcolor="red")
word_check.place(x=800,y=200)
word_check.focus()
btncheck = Button(window, text="Submit",bg="purple", fg="white",width=5,font=('Helvetica','20'),command=checkspells)
btncheck.place(x = 880, y = 250)

label=Label(window,text="Score = 0",font=('Helvetica','15'))
label.place(x=880, y=160)
window.after(40000, quit_pro)
window.mainloop()
